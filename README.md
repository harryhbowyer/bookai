This project is to be used with gen AI, using tools like an ide+extension (vscode+roocode or kilocode as an example), or a cli (like kilocode cli, amazon q, etc).
